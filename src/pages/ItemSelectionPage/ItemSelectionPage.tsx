...
//           </div>
//         ) : (
//           <div className="flex h-full flex-col items-center mt-[100px] text-gray-500">
...
//       try {
//         const res = await axiosInstance.get<WishlistItemsResponse>('/wishlist/items', {
//           params: {
//             status: WISH_STATUS,
//             take: 50,
//             _ts: Date.now(), // 캐시 방지
...
//   // ✅ 지금 응답엔 category가 없으니까 일단 all만 정상 동작 (추후 서버 필드 생기면 연결)
//   const filteredItems = useMemo(() => {
//     if (activeCategory === 'all') return items;
//     return items; // category 없어서 임시로 그대로 보여줌
...
//       wishItemId,
//       type: selectedItem.type === 'MANUAL' ? 'MANUAL' : 'AUTO',
...
// src/pages/ItemSelectionPage/ItemSelectionPage.tsx
import React, { useEffect, useMemo, useState } from 'react';
import { useLocation, useNavigate } from 'react-router-dom';

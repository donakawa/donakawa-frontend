...
import { checkNicknameDuplicate } from '../../../apis/LoginPage/auth';
  ...
  return (
    <div className="w-full max-w-sm animate-fade-in">
      ...
      <div className="mb-10">
        ...
        <h2 className="mt-2 text-2xl font-bold text-gray-900 leading-tight">닉네임을 입력해 주세요.</h2>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between items-start h-5">
          ...
          <div className="flex-1">
            {errorMessage && <p className="ml-1 text-xs text-red-500 animate-fade-in">{errorMessage}</p>}
          </div>
          {/* 우측: 글자 수 카운터 */}
          <div className="flex items-center gap-1 text-xs shrink-0 ml-2">
            {isValidLength && !errorMessage && <IoCheckmark className="text-primary-600" />}
            <span

...
export default function ReasonModal({ open, onClose }: Props) {
  ...
  return (
    <div className="absolute inset-0 z-[110] bg-black/50 flex items-center justify-center px-5">
      <div className="relative w-[335px] h-[234px] bg-white rounded-[20px] flex flex-col items-center shadow-lg">
        ...
        <div className="mt-[64px] flex flex-col items-center gap-[40px]">
          ...
          <div className="flex flex-col items-center gap-[8px]">
            <h3 className="w-[272px] text-[20px] font-semibold leading-[150%] text-black text-center">
              ...
              <span className="text-[color:var(--color-primary-500)]">위시로 담은 이유</span>를 추가해주세요!
            </h3>
            
            <p className="w-[270px] text-[14px] font-normal leading-[150%] text-[color:var(--color-gray-600)] text-center">
              나에게 꼭 필요한 소비인지 판단하는 데<br />도움이 됩니다.
            </p>
          </div>

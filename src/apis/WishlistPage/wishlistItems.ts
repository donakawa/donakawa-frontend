...
export async function getWishlistFolderItems(
  folderId: string, 
...
export async function updateWishlistItemFolder(
  itemId: string, 
  data: { type: 'AUTO' | 'MANUAL'; folderId: string }
) {
...
export async function updateWishlistItemReason(
  itemId: string, 
  data: { reason: string; type: 'AUTO' | 'MANUAL' }
) {
